...
-- 	org.name AS data_plane,
	...
	COALESCE(o.first_name || ' ' || o.last_name, 'Unassigned') AS owner,
	MAX(MAX(t._fivetran_synced)) OVER()::TIMESTAMP AS data_up_to
...
LEFT JOIN auth0.organization AS org
	...
	AND org._fivetran_deleted IS NULL
WHERE
	1 = 1
