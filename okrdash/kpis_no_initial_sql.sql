...
INNER JOIN (
	...
	FROM fullstory_o_1jfe7s_na1.events AS e
	INNER JOIN plumbing.auth_0_to_hubspot_company AS map
		ON JSON_EXTRACT_PATH_TEXT(JSON_SERIALIZE(e.event_properties.user_properties), 'organizationId_str') = map.auth_0_id
